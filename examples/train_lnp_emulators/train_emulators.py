...
def objective(params):
	...
	model = NeuralNet(**params, out_act=dataset_params[current_dataset]['out_act'])
	emulator = Emulator(
...
dataset_names = ['lnp3']#['lnp', 'lnp3']

dataset_params = { 
#		'lnp': {'out_act': 'relu', 'feature_transform': 'standardize', 'target_transform': 'normalize'},
		'lnp3': {'out_act': 'linear', 'feature_transform': 'standardize', 'target_transform': 'normalize'},
}
