...
param1 = ParameterCategorical(
    ...
    descriptors=[
        [284.484, 37.3, 16.0, 1.0, 2.0],
        [432.7, 98.0, 22.0, 4.0, 5.0],
        [358.563, 66.8, 20.0, 2.0, 4.0],
    ],
)
...
for repeat in range(num_repeats):
    ...
    while len(campaign.observations.get_values()) < budget:
        ...
        print(
            f"repeat {repeat}\tnum obs {len(campaign.observations.get_values())}"
        )
        ...
        bools = [
            sample.to_list()
            == ["48.0", "Compritol_888", "120.0", "0.0", "0.005"]
            for sample in samples
        ]
        print("bools : ", bools)
