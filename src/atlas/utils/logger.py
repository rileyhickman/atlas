...
class MessageLogger:
    ...
    def log_config(self, full_campaign, campaign_config):
        ...
        table.add_column('Functional?', style='cyan', justify='center', no_wrap=True)
        table.add_column('Component Type', style='cyan', justify='center', no_wrap=True)
        table.add_column('Target Conc. [mg/mL]', style='cyan', justify='center', no_wrap=True)
        table.add_column('Solvent', style='cyan', justify='center', no_wrap=True)
