...
def get_param_space(campaign_config):
    ...
    for component in drug_names+lipid_names:
        if prep[component]['levels']:
            ...
            full_space_instructions[component] = prep[component]['fractional_range']
...
def compute_target_conc(campaign_config):
    ...
    for component in drug_names+lipid_names:
        ...
        target_conc_mol = component_info['target_conc']/component_info['mol_wt']*1000.
        component_info['target_conc_mol'] = target_conc_mol
        # total solvent (mL)
        total_solvent = component_info['mass_weighted']/component_info['target_conc']
...
def func_to_full_params(func_batch_params, full_param_space, full_space_instructions):
    ...
    for func_params in func_batch_params:
        ...
        full_batch_params.append(
            ParameterVector().from_dict(full_params_dict, param_space=full_param_space)
        )
...
if __name__ == '__main__':
    ...
    full_batch_params = func_to_full_params(func_batch_params, full_param_space, full_space_instructions)
